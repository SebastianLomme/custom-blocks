...
export default function save({ attributes }) {
	...
	return (
		<div {...blockProps}>
			...
			<RichText.Content tagName="h4" value={attributes.subTitle} className='pom-card-sub-title' />
			
			<RichText.Content tagName="p" value={attributes.description} className='pom-card-description' />
			...
			<Icon
				...
				<RichText.Content tagName="p" value={attributes.choiceOne} />
			</div>
			...
			<Icon
				...
				<RichText.Content tagName="p" value={attributes.choiceTwo} />
			</div>
			
			<RichText.Content tagName="p" value={attributes.footer} className='pom-card-footer' />
